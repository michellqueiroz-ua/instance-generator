...
def get_bus_stops(param, network, node_walk, to_node_walk, max_walking):
    ...
    for lid in network.subway_lines:
        ...
        if not math.isnan(d['u']):
            ...
            if d['option'] == 2:
                ...
                stops_u, walking_time_u = get_bus_stops(param, network, u_walk, max_walking, to_node_walk=True)
                d['stops_u'] = stops_u
                d['walking_time_u'] = walking_time_u
                
            if d['option'] == 3:
                #get new pick up stops (around node v)
                stops_v, walking_time_v = get_bus_stops(param, network, v_walk, max_walking, to_node_walk=False)
                d['stops_v'] = stops_v
            ...
            while nok:
                ...
                while unfeasible_request:
                    ...
                    if request_demand[r].num_origins == -1:
                        ...
                        #print('index origin: ', request_demand[r].origin_zones[random_zone])
                    ...
                    if request_demand[r].num_destinations == -1:
                        ...
                        random_zone = int(random_zone)
                        #print('index dest: ', request_demand[r].destination_zones[random_zone])
