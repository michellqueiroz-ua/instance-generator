...
if __name__ == '__main__':
    ...
    #inst1.add_depot_from_address("Rua Leite Vasconcelos lisboa")
    #inst1.add_school_from_name("École maternelle Duchesse Anne")
    #inst1.add_school_from_name("Maternelle Adoration")
    #inst1.add_school_from_address("Rue Paul Bert Rennes France", 'school in paul bert')
    #inst1.add_depot_from_address("Rue Paul Bert Rennes France")
    #inst1.set_num_schools(2)
    #inst1.set_num_depots(2)
