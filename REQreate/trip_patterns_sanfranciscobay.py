...
# Runnable as a script from inside this directory (python trip_patterns_sanfranciscobay.py) as well as
# via `python -m REQreate.trip_patterns_sanfranciscobay`; put the repository root on sys.path so the
