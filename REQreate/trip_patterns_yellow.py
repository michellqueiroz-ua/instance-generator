...
# Runnable as a script from inside this directory (python trip_patterns_yellow.py) as well as
# via `python -m REQreate.trip_patterns_yellow`; put the repository root on sys.path so the
