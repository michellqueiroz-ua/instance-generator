...
if __name__ == '__main__':
    ...
    inst_directory = '../examples/ODBRP_benchmark_configuration_files/1500_3000_6000/'
    #inst_directory = '../examples/testes/'
    base_save_folder_name = '1500_3000_6000' #give a unique folder name to save the instances
    #EDIT HERE
