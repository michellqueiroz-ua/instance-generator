...
class Instance:
    ...
    def add_school_from_address(self, address_school, school_name):
        ...
        if self.can_set_address_school:
            ...
            school_node_drive = ox.nearest_nodes(self.network.G_drive, school_point[0], school_point[1])
            school_node_walk = ox.nearest_nodes(self.network.G_walk, school_point[0], school_point[1])
    ...
    def add_depot_from_address(self, depot_address):
        ...
        if self.can_set_address_depot:
            ...
            depot_node_drive = ox.nearest_nodes(self.network.G_drive, depot_point[0], depot_point[1])
            depot_node_walk = ox.nearest_nodes(self.network.G_walk, depot_point[0], depot_point[1])
