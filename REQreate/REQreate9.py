# Runnable as a script from inside this directory (python REQreate9.py) as well as
# via `python -m REQreate.REQreate9`; put the repository root on sys.path so the
...
if __name__ == '__main__':
    ...
    inst_directory = '../examples/ODBRP_benchmark_configuration_files/2100_3000_6000/'
    #inst_directory = '../examples/testes/'
    base_save_folder_name = '2100_3000_6000' #give a unique folder name to save the instances
    #EDIT HERE
