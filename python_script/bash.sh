...
#python3 generator_lines_mq_with_osmnx.py  --is_request_generation --base_file_name rennes  --request_demand "normal" 8 h 30 min 100 --origin "random" -1 --destination "random" -1 "EDT" --request_demand "uniform" 8 h 9 h 100 --origin "random" 3 --destination "random" 1 "EDT" --time_window 7 10 h